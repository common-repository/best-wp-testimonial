 ...
 */
function bwpt_register_meta_testi_boxes() {
    add_meta_box( 'testi-box-id', __( 'Testimonial Information', 'bwpt' ), 'bwpt_testi_display_callback', 'testimonial' );
}
add_action( 'add_meta_boxes', 'bwpt_register_meta_testi_boxes' );
 ...
 */
function bwpt_testi_display_callback( $post ) {
 ...
 */
function bwpt_testi_save_meta_box( $post_id ) {
...
add_action( 'save_post', 'bwpt_testi_save_meta_box' );
?>